...
// Instagram Section - Home Page Settings.
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Instagram Section', 'endurance' ),
		'id'               => 'endurance_instagram_section',
		'customizer_width' => '400px',
		'subsection'       => true,
		'icon'             => 'el el-instagram',
		'fields'           => array(
			array(
				'id'           => 'endurance_instagram_background_image',
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Background Image', 'endurance' ),
				'compiler'     => 'true',
				...
				'preview_size' => 'full',
				'default'      => array(
					'url' => get_template_directory_uri() . '/assets/images/background/paper-texture.webp',
				),
			),
			array(
				'id'      => 'endurance_instagram_section_follow_text',
				'type'    => 'text',
				'title'   => esc_html__( 'Follow Us Text', 'endurance' ),
				'default' => 'Follow Us on Instagram',
			),
			array(
				'id'      => 'endurance_instagram_section_username',
				'type'    => 'text',
				'title'   => esc_html__( 'Username', 'endurance' ),
				'default' => '@Gymfit',
			),
			array(
				'id'       => 'endurance_instagram_section_username_link',
				'type'     => 'text',
				'validate' => 'url',
				'title'    => esc_html__( 'Username Link', 'endurance' ),
				'default'  => '#',
			),
			array(
				'id'      => 'endurance_instagram_section_shortcode',
				'type'    => 'text',
				'title'   => esc_html__( 'Shortcode (Generated by Smash Balloon Instagram Feed)', 'endurance' ),
				'default' => '[instagram-feed feed=1]',
			),
			array(
				'id'             => 'endurance_instagram_section_username_link_color',
				'type'           => 'color_gradient',
				'title'          => esc_html__( 'Username Link Color', 'endurance' ),
				'gradient-type'  => true,
				'gradient-reach' => true,
				'gradient-angle' => true,
				'preview'        => true,
